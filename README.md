# Smart-tendon-rehab-8051
A basic model for a smart tendon rehabilitation wearable device using 8051 Microcontroller.
## Key Features
* **MPU6050 Integration**: Monitors joint angle in real-time.
* **Alert System**: LED and Buzzer triggers when limits are reached.
* **Active Blocking**: Servo motor prevents further motion for safety.
